...
export const articles: Article[] = [
  {
    ...
    image: "/images/actualites/placeholder-1.jpg",
    excerpt:
      "JS TECH lance son site vitrine pour présenter ses formations et services informatiques.",
    content:
      "Les actualités réelles de JS TECH — formations, événements, Promo Vacances — seront publiées ici prochainement.",
    category: "Annonce",
    isDemo: true,
  },
];
