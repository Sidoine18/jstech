      ...
      <div className="container-jst flex h-20 items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 shrink-0">
          ...
          <span className="hidden flex-col leading-tight sm:flex">
            <span className="font-display text-base font-bold text-ink-900">JS TECH</span>
            <span className="text-[11px] text-ink-700/60">Formations &amp; services informatiques</span>
          </span>
        </Link>
